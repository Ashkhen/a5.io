    ...
    if (!b) {
        ...
        b.BackgroundStyleInfo = b.StyleInfoBase.newStyleInfo({cssProperty: b.CSS_PREFIX + "background", styleProperty: b.STYLE_PREFIX +
            ...
            if (this.getCss3()) {
                ...
                if (f !== "none")v.bgImages = [
                    {imgType: "image", imgUrl: (new b.Tokenizer(f)).next().tokenValue, imgRepeat: i[c.REPEAT], bgPosition: new b.BgPosition((new b.Tokenizer(a + " " + d)).all())}
                ]
            } : function () {
                ...
                if ((k = d.length) && d[0] !== "none") {
                    ...
                    c = i[c.SIZE].split(a);
                    v.bgImages = [];
                    for (a = 0; a < k; a++)if ((l = d[a]) && l !== "none")m = c[a].split(" "), v.bgImages.push({origString: l + " " + f[a] + " " + g[a] + " / " + c[a] + " " + h[a] + " " + j[a], imgType: "image", imgUrl: (new b.Tokenizer(l)).next().tokenValue, imgRepeat: f[a], bgPosition: new b.BgPosition((new b.Tokenizer(g[a])).all()), bgOrigin: h[a], bgClip: j[a], bgSize: new b.BgSize(m[0], m[1])})
                }
            });
        ...
        (function () {
            b.BorderRadiusStyleInfo = b.StyleInfoBase.newStyleInfo({cssProperty: "border-radius", styleProperty: "borderRadius", parseCss: function (c) {
                ...
                if (c) {
                    ...
                    if (c = m())j ? j.tokenType & b.Tokenizer.Type.OPERATOR && j.tokenValue === "/" && (d = m()) : d = c, l && c && d && (a = {x: c, y: d})
                }
                return a
            }});
        ...
        b.BoxShadowStyleInfo = b.StyleInfoBase.newStyleInfo({cssProperty: "box-shadow", styleProperty: "boxShadow", parseCss: function (c) {
            ...
            if (c) {
                ...
                for (c = function () {
                    ...
                    c = n && n.length;
                    if (c > 1 &&
                        c < 5)return(p ? a.inset : a.outset).push({xOffset: d(n[0].tokenValue), yOffset: d(n[1].tokenValue), blur: d(n[2] ? n[2].tokenValue : "0"), spread: d(n[3] ? n[3].tokenValue : "0"), color: b.getColor(m || "currentColor")}), !0;
                    return!1
                }; c(););
            }
        ...
        b.BorderRenderer = b.RendererBase.newRenderer({boxZIndex: 4,
            boxName: "border", needsUpdate: function () {
                ...
                if (j.isActive())if (b = j.getProps(), j = b.widths, r = b.styles, s = b.colors, b.widthsSame && b.stylesSame && b.colorsSame)s.t.alpha() > 0 && (b = j.t.pixels(a), n = b / 2, k.push({path: this.getBoxPath({t: n, r: n, b: n, l: n}, c), stroke: r.t, color: s.t, weight: b})); else {
                    c = c || 1;
